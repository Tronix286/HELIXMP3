 ...
 **************************************************************************************/
int32_t MP3FindSyncWord(unsigned char *buf, int32_t nBytes)
{
	int32_t i;
 ...
 **************************************************************************************/
static int32_t MP3FindFreeSync(unsigned char *buf, unsigned char firstFH[4], int32_t nBytes)
{
	int32_t offset = 0;
...
void MP3GetLastFrameInfo(HMP3Decoder hMP3Decoder, MP3FrameInfo *mp3FrameInfo)
{
	...
	if (!mp3DecInfo || mp3DecInfo->layer != 3) {
		...
		mp3FrameInfo->outputSamps = mp3DecInfo->nChans * (uint32_t)samplesPerFrameTab[mp3DecInfo->version][mp3DecInfo->layer - 1];
 ...
 **************************************************************************************/
int32_t MP3GetNextFrameInfo(HMP3Decoder hMP3Decoder, MP3FrameInfo *mp3FrameInfo, unsigned char *buf)
{
	MP3DecInfo *mp3DecInfo = (MP3DecInfo *)hMP3Decoder;
 ...
 **************************************************************************************/
int32_t MP3Decode(HMP3Decoder hMP3Decoder, unsigned char **inbuf, int32_t *bytesLeft, short *outbuf, int32_t useSize)
{
