 ...
 */
int32_t poly43lo[5] = { 0x29a0bda9, 0xb02e4828, 0x5957aa1b, 0x236c498d, 0xff581859 };
int32_t poly43hi[5] = { 0x10852163, 0xd333f6a4, 0x46e9408b, 0x27c2cef0, 0xfef577b4 };

/* pow(2, i*4/3) as exp and frac */
int32_t pow2exp[8]  = { 14, 13, 11, 10, 9, 7, 6, 5 };
 ...
 **************************************************************************************/
static int32_t DequantBlock(int32_t *inbuf, int32_t *outbuf, int32_t num, int32_t scale)
{
	int32_t tab4[4];
