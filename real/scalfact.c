 ...
 **************************************************************************************/
static void UnpackSFMPEG1(BitStreamInfo *bsi, SideInfoSub *sis, ScaleFactorInfoSub *sfis, int32_t *scfsi, int32_t gr, ScaleFactorInfoSub *sfisGr0)
{
	int32_t sfb;
	int32_t slen0, slen1;
	
	/* these can be 0, so make sure GetBits(bsi, 0) returns 0 (no >> 32 or anything) */
	slen0 = (int32_t)SFLenTab[sis->sfCompress][0];
	slen1 = (int32_t)SFLenTab[sis->sfCompress][1];
 ...
 *                with (x / m) * m, etc.)
 **************************************************************************************/
static void UnpackSFMPEG2(BitStreamInfo *bsi, SideInfoSub *sis, ScaleFactorInfoSub *sfis, int32_t gr, int32_t ch, int32_t modeExt, ScaleFactorJS *sfjs)
{
 ...
 **************************************************************************************/
int32_t UnpackScaleFactors(MP3DecInfo *mp3DecInfo, unsigned char *buf, int32_t *bitOffset, int32_t bitsAvail, int32_t gr, int32_t ch)
{
	int32_t bitsUsed;
