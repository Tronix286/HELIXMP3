...
static int32_t DecodeHuffmanPairs(int32_t *xy, int32_t nVals, int32_t tabIdx, int32_t bitsLeft, unsigned char *buf, int32_t bitOffset)
{
	int32_t i, x, y;
 ...
 **************************************************************************************/
// no improvement with section=data
static int32_t DecodeHuffmanQuads(int32_t *vwxy, int32_t nVals, int32_t tabIdx, int32_t bitsLeft, unsigned char *buf, int32_t bitOffset)
{
	int32_t i, v, w, x, y;
