...
int32_t DecodeHuffman(MP3DecInfo *mp3DecInfo, unsigned char *buf, int32_t *bitOffset, int32_t huffBlockBits, int32_t gr, int32_t ch);
int32_t Dequantize(MP3DecInfo *mp3DecInfo, int32_t gr);
...
int32_t Subband(MP3DecInfo *mp3DecInfo, short *pcmBuf);
